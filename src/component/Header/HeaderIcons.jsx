    ...
    {user &&  <span className="block text-sm  text-center text-gray-500 truncate dark:text-gray-400">{user.email}</span>}
        ...
        <ul className="py-2" aria-labelledby="user-menu-button">
         {user ? <> <li onClick={()=>setIsDropdownOpen(!isDropdownOpen)}
          ...
          >
            <button className="w-full cursor-pointer block px-4 py-2 text-sm text-gray-700 hover:bg-gray-100 dark:hover:bg-gray-600 dark:text-gray-200 dark:hover:text-white">Sign out</button>
          </li></>
