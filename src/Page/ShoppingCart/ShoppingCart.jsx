...
// import bg  from '../../assets/image/bg'
    ...
    <section className="max-w-[1170px] mx-auto  bg-slate-200 font-poppins md:h-screen  ">
      <div className="justify-center flex-1 mx-auto  ">
        <div className="p-8  dark:bg-gray-800">
          <div className='py-10 bg-[url("https://media.istockphoto.com/photos/golden-shopping-bag-with-black-shopping-bags-picture-id1281319569?k=20&m=1281319569&s=612x612&w=0&h=HiPaofdFtZQFc8TVzBabuG_NW8KNvLs9xC_7JRt4U9Q=")] bg-cover object-cover bg-no-repeat'>
            ...
            <div className="w-full px-4 xl:w-4/12">
              <div className="p-6 border border-blue-100 dark:bg-gray-900 dark:border-gray-900 bg-blue-50 md:p-8">
                ...
                <div className="flex items-center justify-between pb-4 mb-4 border-b border-gray-300 dark:border-gray-700 ">
                  ...
                  <span className="text-xl font-bold text-gray-700 dark:text-gray-400 ">${cart.cartTotalAmount}</span>
                </div>
                ...
                <div className="flex items-center justify-between ">
                  <a href='/Checkout'
                   className="block w-full py-4 font-bold text-center text-gray-100 uppercase bg-blue-500 rounded-md hover:bg-blue-600">Checkout</a>
                </div>
              </div>
            </div>
          </div>
