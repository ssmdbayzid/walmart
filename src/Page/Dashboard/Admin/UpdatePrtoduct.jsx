...
const UpdatePrtoduct = ({setOpenEditModal, openEditModal, products}) => {
  ...
  return (
    ...
    <div class="relative w-full px-3 md:px-0 md:w-1/2 max-h-full ">
  ...
  <div className=" px-4  mx-auto py-5">
    ...
    <div onClick={()=>setOpenEditModal(!openEditModal)} className=" cursor-pointer ml-[20%] text-red-600 hover:text-red-800">
        <p><RxCross1 className='h-8 w-8' /> </p>
    </div>
    </div>
